...
function sayHi() { //* экспорт по умолчанию должен быть один
  console.log('Hello!');
}
...
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.js */ "./src/js/main.js");
 //* импорт из другого файла //* если подключать модули в index.html надо полностью прописывать путь - main.js
...
// // data.sayHi(); //* работает при не дефолтном экспорте в файле main.js
 ...
 //* если подключать модули в index.html надо полностью прописывать путь - main.js
