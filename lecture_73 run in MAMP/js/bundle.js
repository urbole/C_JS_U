...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  modalTrigger.forEach(btn => btn.addEventListener('click', () => openModal(modalSelector, modalTimerId))); //* пример того как дать аргумент функции не вызывая ее сразу-же - обернуть ее в стрелочную функцию
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2021-10-01');
